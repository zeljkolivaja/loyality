...
<section id="intro">
    <ul id="slippry-slider">
      ...
      <li>
        <a href="#slide2"><img src="assets/img/slide/2.jpg" alt="Posjetite nas i uživajte u mnogim PC i PS4 naslovima"></a>
      </li>
      <li>
          ...
          <b> Čestitamo, imate dovoljno bodova za : {{$reward->name}} :) </b>
           ...
           @endif --}}
             ...
             <li class="list-group-item">
                <div class="progress">
                    <div class="progress-bar progress-bar-striped" role="progressbar" style="width: {{$venue->pivot->points / $reward->reward_points * 100}}%;"
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="grid effect" id="grid">
            ...
            <li><a href="assets/img/portfolio/7.jpg" class="fancybox" data-fancybox-group="gallery" title="OVERWATCH"><img
                  src="assets/img/portfolio/7.jpg" alt="" /></a></li>
            <li><a href="assets/img/portfolio/8.jpg" class="fancybox" data-fancybox-group="gallery" title="Paladins"><img
                  src="assets/img/portfolio/8.jpg" alt="" /></a></li>
            <li><a href="assets/img/portfolio/9.jpg" class="fancybox" data-fancybox-group="gallery" title="Counter Strike GO"><img
                  src="assets/img/portfolio/9.jpg" alt="" /></a></li>
            <li><a href="assets/img/portfolio/10.jpg" class="fancybox" data-fancybox-group="gallery" title="Gran Turismo Sport"><img
                  src="assets/img/portfolio/10.jpg" alt="" /></a></li>
            <li><a href="assets/img/portfolio/11.jpg" class="fancybox" data-fancybox-group="gallery" title="Minecraft"><img
                  src="assets/img/portfolio/11.jpg" alt="" /></a></li>
            <li><a href="assets/img/portfolio/12.jpg" class="fancybox" data-fancybox-group="gallery" title="Left 4 Dead 2"><img
                  src="assets/img/portfolio/12.jpg" alt="" /></a></li>
            <li><a href="assets/img/portfolio/13.jpg" class="fancybox" data-fancybox-group="gallery" title="Call of duty BO 4"><img
                  src="assets/img/portfolio/13.jpg" alt="" /></a></li>
            <li><a href="assets/img/portfolio/14.jpg" class="fancybox" data-fancybox-group="gallery" title="Trackmania Turbo"><img
      ...
      {{-- <div class="row"> --}}
        ...
        {{-- <div class="col-md-6"> --}}
          <div style="width:50%; margin:auto;">
           ...
           <!-- map -->
          <div id="section-map" class="clearfix" style="width:50%; margin:auto;">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2796.068904204493!2d18.735586049919128!3d45.50869153839411!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475ce8cfe221f54f%3A0x495ab31cfb3fbb9d!2sDelta%20Tenja!5e0!3m2!1sen!2shr!4v1582300496675!5m2!1sen!2shr" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
          </div>
        {{-- </div> --}}
      {{-- </div> --}}
    </div>
